 ...
 */
class MScrollChain : public QObject
{
    Q_OBJECT
public:
    ...
    QPoint scrollingAmountLeft() const;

    bool isValidForTarget(const QGraphicsItem *scrollTarget) const;
...
private slots:
    void handleScrollingFinishedForWidget(const QGraphicsWidget *widget);
...
private:
    ...
    QPoint currentOffsetFromRoot() const;
...
private:
    ...
    QPoint initialOffsetFromRoot;
    QPoint totalScrollAmount;
